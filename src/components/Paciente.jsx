const Paciente = ({ paciente, setPaciente, eliminarPaciente }) => {
    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex md:justify-between justify-center mt-10 gap-2">
                ...
                <button
                    type="button"
                    className="py-2 px-10 flex gap-2 bg-red-600 hover:bg-red-700 text-white font-bold uppercase rounded-lg"
